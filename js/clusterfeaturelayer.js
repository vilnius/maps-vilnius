define([
    ...
    'dojo/on',
    'dojo/promise/all',
    'dojo/dom-class', //AG add popup class
    ...
    declare, arrayUtils, lang, Color, connect, on, all, domClass,
    ...
    return declare([GraphicsLayer], {
        constructor: function(options) {
            ...
            this._singleSym = options.singleSymbol || new SimpleMarkerSymbol('circle', 16,
                                    new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([85, 125, 140, 0]), 3),
        ...
        _getDefaultSymbol: function (g) {
            ...
            if (!this._useDefaultSymbol || !rend) {
	            //AG get different symbols
	            var galiojaKEY = g.attributes.GALIOJA;
	            if ((galiojaKEY === 1) || (galiojaKEY === 3)) {
                    //adClusterTemplate.setTitle("Galiojantis reklamos registro leidimas");
                    domClass.contains("ad", "invalid-ad") ? domClass.remove("ad", "invalid-ad") : domClass.add("ad", "valid-ad");
                    domClass.add("ad", "valid-ad");                    
		            return new SimpleMarkerSymbol("circle", 16,
		                        new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([44, 162, 95, 1]), 1),
		                        new Color([153, 216, 201, 1]));
		        } else if (galiojaKEY === 2) {
                    //adClusterTemplate.setTitle("Negaliojantis reklamos registro leidimas");
                    domClass.contains("ad", "valid-ad") ? domClass.remove("ad", "valid-ad") : domClass.add("ad", "invalid-ad"); 
                    domClass.add("ad", "invalid-ad");                    
		            return new SimpleMarkerSymbol("circle", 16,
		                        new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([193, 39, 45, 1]), 1),
		                        new Color([241, 122, 127, 1]));	
	            } else {
        ...
        _getRenderedSymbol: function (feature) {
	        //console.log("_getRenderedSymbol:");
	        //console.log(feature);
	        //console.log("END_getRenderedSymbol:");
            var attr = feature.attributes;
            if (attr.clusterCount === 1) {
                if (!this._useDefaultSymbol) {
		            //AG get different symbols with newlys created VALID ID
		            var galiojaKEY = feature.attributes.VALID;
		            if ((galiojaKEY === 1) || (galiojaKEY === 3)) {
                        //adClusterTemplate.setTitle("Galiojantis reklamos registro leidimas");
			            return new SimpleMarkerSymbol("circle", 16,
			                        new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([44, 162, 95, 1]), 1),
        ...
        onClick: function(e) {
            ...
            // Multi-cluster click, show popup by finding actual singles and assigning to infoWindow
                ...
                if ( singles.length > this._maxSingles ) {
                    ...
                    this._addSingleGraphics(singles);
                    if (!this._disablePopup) {
	                    //AG paduodamas masyvas skirtas popup infowindow
        ...
        _clusterAddPoint: function(feature, p, cluster) {
	        	    ...
	        	    //console.log("_clusterAddPoint g:");
	                //console.log(feature);	
	                //console.log(p);	
	                //console.log(cluster);	
            ...
            //AG create ID and other attributes for  cluster, LT: perduodame ID nr ir kitus atributus clusterio taskui, PASTABA: NEAISKU ar dar NAUDOTI, nes VALID attributas sukuriamas tik bendram clusterio taskui
            //p.attributes.UNIQUEID = cluster.attributes.UNIQUEID = feature.attributes.ID;
            //p.attributes.VALID = cluster.attributes.VALID = feature.attributes.GALIOJA;
        ...
        _clusterCreate: function(feature, p) {
            ...
            var cluster = {
                ...
                'attributes' : {
                    'clusterCount': 1,
                    "ID": feature.attributes.ID, //AG create ID attribute  for every single point                   
                    "VALID": feature.attributes.GALIOJA, //AG create VALID attribute  for every single point                   
                    'clusterId': clusterId,
        ...
        _showCluster: function(c) {
	        //console.log("_showCluster:");
	        //console.log(c);
	        //console.log("END_showCluster");	        
        ...
        _addSingleGraphics: function(singles) {
	        //console.log(singles); //AG feature atributai
            ...
            arrayUtils.forEach(singles, function(g) {
                ...
                //g.setSymbol(this._getDefaultSymbol(g));
                g.setInfoTemplate(this._singleTemplate);
                //console.log(g);//AG feature atributai
