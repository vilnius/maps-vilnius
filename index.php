		...
		<div id="map" data-dojo-type="dijit/layout/ContentPane" data-dojo-props="splitter:false, region:'center'">
			...
			<div id="open-data" class="sub-menu module animate color-layers">
				...
				<div class="inner">
					...
					<p><a href="http://gis.opendata.lt/" target="_blank">www.gis.opendata.lt</a></p>
				</div>
				<div id="tools-measure"></div>
			</div>
			...
			<!-- End Buildings info -->
			<div id="ortofoto">
				<div id="ort" style="display:block;">
					<h4>Ortofoto</h4></div>
				<div id="zem" style="display:none;">
					<h4>Žemėlapis</h4></div>
			</div>
			<div id="search"></div>
			<div id="extent">
			...
			<div id="help-gallery" class="animate">
				<a href="#" class="button close animate" title="Uždaryti">✕</a>
				    ...
				    <div class="pswp__scroll-wrap">
				        ...
				        <div class="pswp__ui pswp__ui--hidden">
				            ...
				            <div class="pswp__top-bar">
				                ...
				                <button class="pswp__button pswp__button--close" title="Išjungti (Esc)"></button>
				
								<!-- <button class="pswp__button pswp__button--share" title="Share"></button> -->
				
				                <button class="pswp__button pswp__button--fs" title="Žiūrėti per visą ekraną"></button>
				
				                <button class="pswp__button pswp__button--zoom" title="Artinti/Tolinti"></button>
				            ...
				            <button class="pswp__button pswp__button--arrow--right" title="Toliau">
				            </button>
